...
{
    public class CancelTransferLogCommand : SaveTransferLogCommand
    {
    }
    public class  CancelTransferLogCommandHandler : ICommandHandler<CancelTransferLogCommand, ValidationResult>
    {
        ...
        public CancelTransferLogCommandHandler(IRepository<TransferLog, Guid> transferRepository,  
        ...
        public async Task<ValidationResult> Handle(CancelTransferLogCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                transferLog.Status = TransferLogStatus.Cancelled;
