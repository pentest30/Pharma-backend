...
{
    public class DeleteTransferLogCommand : SaveTransferLogCommand
    {
    }
     public class DeleteTransferLogCommandHandler : ICommandHandler<DeleteTransferLogCommand, ValidationResult>
     {
         ...
         public DeleteTransferLogCommandHandler(IRepository<TransferLog, Guid> transferRepository,  
         ...
         public async Task<ValidationResult> Handle(DeleteTransferLogCommand request, CancellationToken cancellationToken)
         {
             ...
             try
             {
                 ...
                 transferLog.Status = TransferLogStatus.Removed;
