...
{
    public class DeleteZoneTypeCommand : ICommand
    {
        public Guid Id { get; set; }
    }
    public class DeleteZoneTypeCommandHandler : ICommandHandler<DeleteZoneTypeCommand>
    {
        ...
        public DeleteZoneTypeCommandHandler(IRepository<ZoneType, Guid> zoneTypeRepository,
            IMapper mapper,
