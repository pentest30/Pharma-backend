...
namespace GHPCommerce.Modules.Procurement.Repositories
{
    ...
    {
        protected readonly ProcurementDbContext DbContext;
        ...
        public Repository(ProcurementDbContext dbContext, IDateTimeProvider dateTimeProvider,ICurrentUser currentUser)
        {
            DbContext = dbContext;
