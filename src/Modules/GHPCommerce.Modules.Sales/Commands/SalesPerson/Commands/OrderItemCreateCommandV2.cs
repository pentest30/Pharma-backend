...
namespace GHPCommerce.Modules.Sales.Commands.SalesPerson.Commands
{
    public class OrderItemCreateCommandV2: ICommand<ValidationResult>,IOrderItem
    {
    ...
    public class OrderItemCreateCommandV2Validator : AbstractValidator<OrderItemCreateCommandV2>
    {
        public OrderItemCreateCommandV2Validator()
        {
            ...
            //     .NotEmpty()
            //     .When(x => x.OrderType == OrderType.Psychotrope);
        }
    }
}
