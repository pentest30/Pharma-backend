...
namespace GHPCommerce.Migrator.Migrations.ApplicationDb
{
    ...
    [Migration("20230308132850_superadmin")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Catalog.TransactionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<long>("CodeTransaction")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TransactionType","Catalog");
                });
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("b512f030-544c-eb11-9ce0-a4c3f0d0650b"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "SalesManager",
                        ...
                        new
                        {
                            Id = new Guid("b512f030-544c-eef1-9ce0-a4c3f0d0650b"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Supervisor",
                        ...
                        new
                        {
                            Id = new Guid("d63c47de-852f-4ce7-93e1-c3db21a06d48"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Executer",
                            NormalizedName = "EXECUTER"
                        },
                        new
                        {
                            Id = new Guid("ec6e3c62-a47d-4e35-bc41-cda44e16afc2"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Controller",
                        ...
                        new
                        {
                            Id = new Guid("8a8479d1-b0c7-43d6-8896-175cbcd27af8"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "PrintingAgent",
                            NormalizedName = "PRINTINGAGENT"
                        },
                        new
                        {
                            Id = new Guid("8c2f6a37-f308-438a-b39b-1400675ac734"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Consolidator",
                            NormalizedName = "CONSOLIDATOR"
                        });
                });
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AAJXI17tYiHj1+Yu+eoa4c9jq2FyRvD5WgPxem9c9TlhYDO8jdQjgOsOd2BicXSFxQA==",
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("12837d3d-793f-eb11-becc-5cea1d05f660"),
                            CreatedByUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            RoleId = new Guid("b512f030-544c-eb11-9ce0-a4c3f0d0209b"),
                            UserId = new Guid("12837d3d-793f-ea11-becb-5cea1d05f660")
                        });
                });
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Shared.LogRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Tiers.SupplierCustomer", b =>
                {
                    ...
                    b.Property<Guid?>("ActualSalesPerson")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ActualSalesPersonName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GHPCommerce.Domain.Domain.Catalog.PickingZone", b =>
                {
                    b.HasOne("GHPCommerce.Domain.Domain.Catalog.ZoneGroup", "ZoneGroup")
