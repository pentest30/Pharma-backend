...
{
    public partial class AddCreditNoteModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductReturn = table.Column<bool>(nullable: false),
                    ClaimNumber = table.Column<string>(nullable: true),
                    ClaimNote = table.Column<string>(nullable: true),
                    ClaimReason = table.Column<long>(nullable: true),
                    ...
                    CreditNoteType = table.Column<long>(nullable: false),
